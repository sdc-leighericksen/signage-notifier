...
The request body must be a JSON object with the `body` field containing a **JSON string** of the notification payload:

```json
{
  "body": "{\"title\":\"...\",\"description\":\"...\",\"color\":\"#00AA00\",\"image\":\"good\"}",
  "async": false
}
```
